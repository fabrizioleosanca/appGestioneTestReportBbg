...
Public Class CrystalReportBBG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "appGestioneTestReportBbg.CrystalReportBBG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportBBG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportBBG = New CrystalReportBBG()
        rpt.Site = Me.Site
        Return rpt
    End Function
